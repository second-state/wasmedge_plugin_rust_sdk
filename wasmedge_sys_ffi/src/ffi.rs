...
// bindgen --impl-debug --size_t-is-usize --no-layout-tests  ./WasmEdge/build/include/api/wasmedge/wasmedge.h --no-prepend-enum-name --dynamic-link-require-all --allowlist-type="WasmEdge.*" --allowlist-var="WasmEdge.*" --allowlist-function="WasmEdge.*" -o ffi.rs -- -I./WasmEdge/build/include/api
...
pub const WasmEdge_Proposal_GC: WasmEdge_Proposal = 15;
...
pub const WasmEdge_ErrCode_MalformedTable: WasmEdge_ErrCode = 60;
...
pub const WasmEdge_ErrCode_ReadUnsetLocal: WasmEdge_ErrCode = 86;
pub const WasmEdge_ErrCode_InvalidBrRefType: WasmEdge_ErrCode = 87;
...
pub const WasmEdge_ErrCode_CastNullptrToNonNull: WasmEdge_ErrCode = 145;
...
pub const WasmEdge_ValTypeCode_I32: WasmEdge_ValTypeCode = 127;
pub const WasmEdge_ValTypeCode_I64: WasmEdge_ValTypeCode = 126;
pub const WasmEdge_ValTypeCode_F32: WasmEdge_ValTypeCode = 125;
pub const WasmEdge_ValTypeCode_F64: WasmEdge_ValTypeCode = 124;
pub const WasmEdge_ValTypeCode_V128: WasmEdge_ValTypeCode = 123;
pub const WasmEdge_ValTypeCode_FuncRef: WasmEdge_ValTypeCode = 112;
pub const WasmEdge_ValTypeCode_ExternRef: WasmEdge_ValTypeCode = 111;
pub type WasmEdge_ValTypeCode = ::std::os::raw::c_uint;
pub const WasmEdge_HeapTypeCode_Func: WasmEdge_HeapTypeCode = 112;
pub const WasmEdge_HeapTypeCode_Extern: WasmEdge_HeapTypeCode = 111;
pub const WasmEdge_HeapTypeCode_Any: WasmEdge_HeapTypeCode = 110;
pub const WasmEdge_HeapTypeCode_Eq: WasmEdge_HeapTypeCode = 109;
pub const WasmEdge_HeapTypeCode_I31: WasmEdge_HeapTypeCode = 106;
pub const WasmEdge_HeapTypeCode_NoFunc: WasmEdge_HeapTypeCode = 105;
pub const WasmEdge_HeapTypeCode_NoExtern: WasmEdge_HeapTypeCode = 104;
pub const WasmEdge_HeapTypeCode_Struct: WasmEdge_HeapTypeCode = 103;
pub const WasmEdge_HeapTypeCode_Array: WasmEdge_HeapTypeCode = 102;
pub const WasmEdge_HeapTypeCode_None: WasmEdge_HeapTypeCode = 101;
pub const WasmEdge_HeapTypeCode_Defined: WasmEdge_HeapTypeCode = 255;
pub type WasmEdge_HeapTypeCode = ::std::os::raw::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct WasmEdge_HeapType {
    pub HeapTypeCode: WasmEdge_HeapTypeCode,
    pub DefinedTypeIdx: u32,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union WasmEdge_ValTypeExt {
    pub HeapType: WasmEdge_HeapType,
}
impl ::std::fmt::Debug for WasmEdge_ValTypeExt {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(f, "WasmEdge_ValTypeExt {{ union }}")
    }
}
#[repr(C)]
#[derive(Copy, Clone)]
pub struct WasmEdge_FullValType {
    pub TypeCode: WasmEdge_ValTypeCode,
    pub Ext: WasmEdge_ValTypeExt,
}
impl ::std::fmt::Debug for WasmEdge_FullValType {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "WasmEdge_FullValType {{ TypeCode: {:?}, Ext: {:?} }}",
            self.TypeCode, self.Ext
        )
    }
}
...
pub const WasmEdge_RefTypeCode_Ref: WasmEdge_RefTypeCode = 107;
pub const WasmEdge_RefTypeCode_RefNull: WasmEdge_RefTypeCode = 108;
pub type WasmEdge_RefTypeCode = ::std::os::raw::c_uint;
...
pub struct WasmEdge_Value {
    pub Value: uint128_t,
    pub Type: WasmEdge_FullValType,
}
impl ::std::fmt::Debug for WasmEdge_Value {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            f,
            "WasmEdge_Value {{ Value: {:?}, Type: {:?} }}",
...
extern "C" {
    pub fn WasmEdge_FunctionTypeCreateV2(
        ParamList: *const WasmEdge_FullValType,
        ParamLen: u32,
        ReturnList: *const WasmEdge_FullValType,
        ReturnLen: u32,
    ) -> *mut WasmEdge_FunctionTypeContext;
}
extern "C" {
